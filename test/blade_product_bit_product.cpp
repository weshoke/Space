...
static_assert(brigand::front<BitProduct<MC2, 0b01, 0b01>>::Scale<float>() == 1.f,
              "BitProduct error");
// e1 * e2
...
static_assert(brigand::front<BitProduct<MC2, 0b01, 0b10>>::Scale<float>() == 1.f,
              "BitProduct error");
// e1 * ori
...
static_assert(brigand::front<BitProduct<MC2, 0b001, 0b100>>::Scale<float>() == 1.f,
              "BitProduct error");
// e1 * inf
...
static_assert(brigand::front<BitProduct<MC2, 0b0001, 0b1000>>::Scale<float>() == 1.f,
              "BitProduct error");
// (e1 ^ ori) * e1
...
static_assert(brigand::front<BitProduct<MC2, 0b0101, 0b0001>>::Scale<float>() == -1.f,
              "BitProduct error");
// (e1 ^ ori) * ori
...
static_assert(brigand::front<BitProduct<MC2, 0b1001, 0b0001>>::Scale<float>() == -1.f,
              "BitProduct error");
// (e1 ^ inf) * inf
...
static_assert(brigand::front<BitProduct<MC2, 0b0100, 0b1000>>::Scale<float>() == -1.f,
              "BitProduct error");
static_assert(brigand::back<BitProduct<MC2, 0b0100, 0b1000>>::value == 0b1100, "BitProduct error");
static_assert(brigand::back<BitProduct<MC2, 0b0100, 0b1000>>::Scale<float>() == 1.f,
              "BitProduct error");
// inf * ori
...
static_assert(brigand::front<BitProduct<MC2, 0b1000, 0b0100>>::Scale<float>() == -1.f,
              "BitProduct error");
static_assert(brigand::back<BitProduct<MC2, 0b1000, 0b0100>>::value == 0b1100, "BitProduct error");
static_assert(brigand::back<BitProduct<MC2, 0b1000, 0b0100>>::Scale<float>() == -1.f,
              "BitProduct error");
